...
![BB 前端域总览](ch1-module-connection-v14.svg)
...
![BAT 与 Scoreboard](bat-scoreboard-clean.svg)
...
![指令生命周期-回收](life-complete-v2.svg)
...
![微指令生命周期-拆分](micro-life-split-v2.svg)
...
![微指令生命周期-调度](micro-life-schedule-v2.svg)
